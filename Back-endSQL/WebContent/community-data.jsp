	...
	<header>
        <nav class="navbar">
	            ...
	            <ul class="navbar-nav">
	                ...
	                <c:if test="${user == 'community'}">
	               		<li><a href="<%=request.getContextPath()%>/listpatientcommunity">Patients in my Community</a></li>
	                	<li id = "nav-login"><a href="login-form.jsp">Logout</a></li>
					</c:if>
					<c:if test="${user != 'community'}">
	                	<li id = "nav-login"><a href="visit-summary.jsp">Login</a></li>
					</c:if>
	...
	<div class="row">
		<div class="container">
			...
			<table class="commPatient-table">
				...
				<tbody>
					<c:forEach var="patient" items="${listpatientcommunity}">
						<tr>
							<td class = "list table-approval">
								<c:if test="${patient.accepted == 0}">
									<a href="approvePatient?ssn=<c:out value='${patient.ssn}' />">Approve</a>&nbsp;&nbsp;&nbsp;&nbsp; 
                               	 	<a href="deletePatient?ssn=<c:out value='${patient.ssn}' />">Deny</a>
                            	</c:if>
                            </td>
